...
@rem echo  example:
@rem echo    build-tcc.bat -t 32 -c "d:/tcc/tcc.exe -m32"
@rem echo    build-tcc.bat -t 32 -c "d:/tcc/tcc.exe -m32" -i "d:/tcc"
@rem ----------------------------------------------------------------
...
echo  --------
echo  example:
echo    build-tcc.bat -t 32 -c "d:/tcc/tcc.exe -m32"
echo    build-tcc.bat -t 32 -c "d:/tcc/tcc.exe -m32" -i "d:/tcc"
exit /B 1
