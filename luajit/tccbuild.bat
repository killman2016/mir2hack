...
rem set PATH=C:\Work\Temp\Lua\lua_forum\tcc-0.9.26\win32;%PATH%
(where tcc > nul 2>&1) || goto :FAIL

set LJHOSTCOMPILE=tcc -m32 -c -D__GNUC__=4
set LJCOMPILE=tcc -m32 -c -D__GNUC__=4
set LJLINK=tcc -m32 -L.
set LJMT=mt /nologo
